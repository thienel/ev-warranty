  ...
  return [
    {
      ...
      sorter: (a: Record<string, unknown>, b: Record<string, unknown>) => {
        ...
        const bModel = b as VehicleModel;
        return (aModel.brand || "").localeCompare(bModel.brand || "");
      },
      sortOrder:
        sortedInfo.columnKey === "brand"
    ...
    },
    {
      ...
      render: (_: unknown, record: Record<string, unknown>) => {
        const vehicleModel = record as VehicleModel;
        return (
          <Space size="small">
            <Button
              type="text"
              icon={<EditOutlined />}
              onClick={() => onOpenModal(vehicleModel, true)}
            />
            <Popconfirm
