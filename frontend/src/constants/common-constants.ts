...
export const API_ENDPOINTS = {
  ...
  CLAIM_ITEM_ACTIONS: {
    ...
    REJECT: (claimId: string, itemId: string) =>
      `/api/v1/claims/${claimId}/items/${itemId}/reject`,
  },
} as const;
...
export type ClaimItemType =
  (typeof CLAIM_ITEM_TYPES)[keyof typeof CLAIM_ITEM_TYPES];
...
export type ClaimItemStatus =
  (typeof CLAIM_ITEM_STATUSES)[keyof typeof CLAIM_ITEM_STATUSES];
