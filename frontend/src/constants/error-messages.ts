...
const ErrorMessages = {
  ...
  API_INVALID_MULTIPART_FORM_REQUEST:
    "There's an issue with your file upload. Please check your files and try again.",
  ...
  CLAIM_MISSING_INFORMATION:
    'Please add all required items and attachments before submitting your claim.',
  ...
  // Cloudinary Errors
  CLOUDINARY_FAILED_INITIALIZE:
    "We're having trouble with our file storage. Please try again later.",
...
export function getErrorMessageFromResponse(error: ErrorResponse): string {
