...
export { default as partsApi } from './partsApi'
export { default as warrantyPoliciesApi } from './warrantyPoliciesApi'
export { default as policyCoveragePartsApi } from './policyCoveragePartsApi'
...
export { partsApi as parts } from './partsApi'
export { warrantyPoliciesApi as warrantyPolicies } from './warrantyPoliciesApi'
export { policyCoveragePartsApi as policyCoverageParts } from './policyCoveragePartsApi'
