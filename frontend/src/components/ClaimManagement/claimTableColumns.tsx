  ...
  return [
      ...
      render: (text: string, record: Record<string, unknown>) => {
        ...
        return (
          ...
          >
            ...
            <span>
              {text || `Customer ${claim.customer_id?.slice(0, 8)}` || "N/A"}
            </span>
          </Space>
        );
      },
      ...
      render: (text: string, record: Record<string, unknown>) => {
        ...
        return (
          ...
          >
            ...
            <span>
              {text || `Vehicle ${claim.vehicle_id?.slice(0, 8)}` || "N/A"}
            </span>
          </Space>
        );
      },
    ...
    },
    {
      ...
      sorter: (a: Record<string, unknown>, b: Record<string, unknown>) => {
        ...
        const bClaim = b as Claim;
        return (
          new Date(aClaim.created_at || 0).getTime() -
          new Date(bClaim.created_at || 0).getTime()
        );
      },
      sortOrder:
