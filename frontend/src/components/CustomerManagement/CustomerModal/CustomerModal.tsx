  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Input placeholder="Enter first name" prefix={<UserOutlined />} size="large" />
        </Form.Item>
        ...
        >
          <Input placeholder="Enter last name" prefix={<UserOutlined />} size="large" />
        </Form.Item>
        ...
        >
          <Input placeholder="Enter email" prefix={<MailOutlined />} size="large" />
        </Form.Item>
        ...
        >
          <Input placeholder="Enter phone number" prefix={<PhoneOutlined />} size="large" />
        </Form.Item>
