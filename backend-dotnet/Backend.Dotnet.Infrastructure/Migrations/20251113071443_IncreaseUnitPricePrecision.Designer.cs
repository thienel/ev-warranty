...
namespace Backend.Dotnet.Infrastructure.Migrations
{
    ...
    [Migration("20251113071443_IncreaseUnitPricePrecision")]
    partial class IncreaseUnitPricePrecision
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Dotnet.Domain.Entities.WarrantyPolicy", b =>
                {
                    ...
                    b.Property<Guid?>("AssignedModelId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Backend.Dotnet.Domain.Entities.WorkOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Backend.Dotnet.Domain.Entities.VehicleModel", b =>
                {
                    b.HasOne("Backend.Dotnet.Domain.Entities.WarrantyPolicy", "Policy")
                        .WithOne()
                        .HasForeignKey("Backend.Dotnet.Domain.Entities.VehicleModel", "PolicyId")
            ...
            modelBuilder.Entity("Backend.Dotnet.Domain.Entities.WarrantyPolicy", b =>
                {
                    b.HasOne("Backend.Dotnet.Domain.Entities.VehicleModel", "AssignedModel")
                        .WithMany()
