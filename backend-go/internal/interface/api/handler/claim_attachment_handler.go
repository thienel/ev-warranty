...
// @Success 200 {object} dto.APIResponse{data=entity.ClaimAttachment} "Claim attachment retrieved successfully"
// @Failure 400 {object} dto.APIResponse "Bad request"
// @Failure 401 {object} dto.APIResponse "Unauthorized"
// @Failure 404 {object} dto.APIResponse "Claim attachment not found"
...
// @Security Bearer
// @Param id path string true "Claim ID"
// @Success 200 {object} dto.APIResponse{data=dto.ClaimAttachmentListResponse} "Claim attachments retrieved successfully"
// @Failure 400 {object} dto.APIResponse "Bad request"
// @Failure 401 {object} dto.APIResponse "Unauthorized"
...
// @Success 201 {object} dto.APIResponse{data=[]entity.ClaimAttachment} "Claim attachments uploaded successfully"
// @Failure 400 {object} dto.APIResponse "Bad request"
// @Failure 401 {object} dto.APIResponse "Unauthorized"
...
func (h *claimAttachmentHandler) Create(c *gin.Context) {
	...
	if err != nil || form == nil {
		writeErrorResponse(h.log, c, apperror.ErrInvalidMultipartForm)
		return
	}
...
// @Param id path string true "Claim ID"
// @Param attachmentID path string true "Attachment ID"
// @Success 204 {object} dto.APIResponse "Claim attachment deleted successfully"
// @Failure 400 {object} dto.APIResponse "Bad request"
// @Failure 401 {object} dto.APIResponse "Unauthorized"
// @Failure 403 {object} dto.APIResponse "Forbidden"
// @Failure 404 {object} dto.APIResponse "Claim attachment not found"
