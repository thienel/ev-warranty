...
func (_m *ClaimAttachmentService) Create(tx application.Tx, claimID uuid.UUID, cmd *services.CreateAttachmentCommand) (*entities.ClaimAttachment, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(application.Tx, uuid.UUID, *services.CreateAttachmentCommand) (*entities.ClaimAttachment, error)); ok {
		return rf(tx, claimID, cmd)
	}
	if rf, ok := ret.Get(0).(func(application.Tx, uuid.UUID, *services.CreateAttachmentCommand) *entities.ClaimAttachment); ok {
	...
	if rf, ok := ret.Get(1).(func(application.Tx, uuid.UUID, *services.CreateAttachmentCommand) error); ok {
...
func (_e *ClaimAttachmentService_Expecter) Create(tx interface{}, claimID interface{}, cmd interface{}) *ClaimAttachmentService_Create_Call {
	return &ClaimAttachmentService_Create_Call{Call: _e.mock.On("Create", tx, claimID, cmd)}
}

func (_c *ClaimAttachmentService_Create_Call) Run(run func(tx application.Tx, claimID uuid.UUID, cmd *services.CreateAttachmentCommand)) *ClaimAttachmentService_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(application.Tx), args[1].(uuid.UUID), args[2].(*services.CreateAttachmentCommand))
	})
	return _c
}
...
func (_c *ClaimAttachmentService_Create_Call) RunAndReturn(run func(application.Tx, uuid.UUID, *services.CreateAttachmentCommand) (*entities.ClaimAttachment, error)) *ClaimAttachmentService_Create_Call {
	_c.Call.Return(run)
	return _c
}
