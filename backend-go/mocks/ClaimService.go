...
//   - tx application.Tx
//   - id uuid.UUID
func (_e *ClaimService_Expecter) Delete(tx interface{}, id interface{}) *ClaimService_Delete_Call {
	return &ClaimService_Delete_Call{Call: _e.mock.On("Delete", tx, id)}
}

func (_c *ClaimService_Delete_Call) Run(run func(tx application.Tx, id uuid.UUID)) *ClaimService_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ClaimService_Delete_Call) RunAndReturn(run func(application.Tx, uuid.UUID) error) *ClaimService_Delete_Call {
	_c.Call.Return(run)
	return _c
}
