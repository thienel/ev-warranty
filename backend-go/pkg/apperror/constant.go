...
var (
	...
	ErrHashPassword        = New(http.StatusInternalServerError, "HASH_PASSWORD_ERROR", "Failed to hash password")
	...
	ErrInvalidFile          = New(http.StatusBadRequest, "API_INVALID_FILE", "Invalid or unreadable file")
	...
	ErrInvalidCredentials         = New(http.StatusUnauthorized, "AUTH_INVALID_CREDENTIALS", "Email or password is not correct")
	...
	ErrInvalidUserID              = New(http.StatusUnauthorized, "AUTH_INVALID_USER_ID", "Invalid user id in claim")
